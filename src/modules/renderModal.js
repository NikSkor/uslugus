...
export const renderModal = (parent, data, closeModal) => {
  ...
  : `${data.phone.slice(0, 2)} (${data.phone.slice(2, 5)}) ${data.phone.slice(4, 7)}-${data.phone.slice(7)}`
  ;
  ...
  const wrapperSendReview = createElement('div', {
    className: 'form__wrapper-review'
  }, formReview);
